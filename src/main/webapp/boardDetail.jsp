...
<%
    ...
    try {
        ...
        sql = "SELECT idx, title, contents, user_id, create_dt, update_dt, hit_cnt FROM t_board ";
        sql += "WHERE idx = ? ";
        pstmt = conn.prepareStatement(sql);
        pstmt.setInt(1, idx);
        ...
        <form action="#" method="post" id="frm">
            <div class="col-sm-6 mx-auto">
                <div class="form-floating my-3">
                    ...
                    <label for="idx" class="form-label">Idx</label>
                </div>
                <div class="form-floating my-3">
                ...
                <div class="form-floating my-3">
                    <input type="text" class="form-control" id="board-cnt" name="boardCnt" placeholder="조회수를 입력하세요" readonly value="<%=hit_cnt%>">
                ...
                <div class="my-3 row">
                    ...
                    <div class="col-sm d-flex justify-content-end">
                        ...
                        <div>
                            <a href="boardDelete.jsp?idx=<%=idx%>" class="btn btn-danger">삭제</a>
                        </div>
                    </div>
                </div>
            </div>
